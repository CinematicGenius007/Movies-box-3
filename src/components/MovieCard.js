...
export default class MovieCard extends Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			getRuntime: () => {
				const rtm = this.props.details.runtime
	...
	render() {
		...
		return (
			<>
			{true && <div className='movie-container' >
				...
				<div className='movie-title'>
					...
					<h5 className='title-sub'>
						...
						{this.props.details.runtime > 0 
							&& <span className='ttSeperator'></span>}
						<span>{this.state.getGenres()}</span>
						{this.props.details.release_date.length > 0 
							&& <span className='ttSeperator'></span>}
						<span>{this.props.details.release_date.slice(0, 4)}</span>
						
					</h5>
				</div>
				<div className='movie-poster-overview'>
					<div className='movie-poster-container'>
						<img className='movie-Poster' src={this.state.getMainImg()} alt='' />
					</div>
				...
				<div className='movie-credits'>
					...
					{window.innerWidth <= 1200 && <div className='movie-casts-media-query-w900'>
